...
In the built-in pipelines, implementation-oriented stages mostly fork, while review starts cold.
...
- `/lattice-retry` to send the run back to the nearest `implementor` stage
